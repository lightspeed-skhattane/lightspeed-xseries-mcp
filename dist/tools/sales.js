...
export async function listSales(params) {
    ...
    return client.list('/register_sales', {
        version: '0.9',
        params: {
...
export async function getSale(saleId) {
    const client = getClient();
    return client.getOne(`/register_sales/${saleId}`, { version: '0.9' });
}
export async function createSale(data) {
    const client = getClient();
    return client.post('/register_sales', data, { version: '0.9' });
}
export async function updateSale(saleId, data) {
    const client = getClient();
    return client.put(`/register_sales/${saleId}`, data, { version: '0.9' });
}
export async function returnSale(saleId, data) {
    const client = getClient();
    return client.put(`/sales/${saleId}/return`, data, { version: '2.0' });
}
// Payment Tools
export async function getPayment(paymentId) {
    const client = getClient();
    return client.getOne(`/payments/${paymentId}`, { version: '2.0' });
}
// Sales API 2.0
export async function listSales2(params) {
    const client = getClient();
    return client.list('/sales', {
        version: '2.0',
        params: {
            page_size: params.page_size,
            after: params.after,
...
export async function getSale2(saleId) {
    const client = getClient();
    return client.getOne(`/sales/${saleId}`, { version: '2.0' });
}
export async function createSale2(data) {
    const client = getClient();
    return client.post('/sales', data, { version: '2.0' });
}
export async function updateSale2(saleId, data) {
    const client = getClient();
    return client.put(`/sales/${saleId}`, data, { version: '2.0' });
}
...
export async function listPaymentTypes() {
    const client = getClient();
    return client.list('/payment_types', { version: '0.9' });
}
export async function listPaymentTypes2(params) {
    const client = getClient();
    return client.list('/payment_types', {
        version: '2.0',
        params: {
            page_size: params.page_size,
            after: params.after,
...
export async function getPaymentType(paymentTypeId) {
    const client = getClient();
    return client.getOne(`/payment_types/${paymentTypeId}`, { version: '2.0' });
}
// Payments listing
export async function listPayments(params) {
    const client = getClient();
    return client.list('/payments', {
        version: '2.0',
        params: {
            page_size: params.page_size,
            after: params.after,
...
export async function listFulfillments(params) {
    const client = getClient();
    return client.list('/fulfillments', {
        version: '2.0',
        params: {
            page_size: params.page_size,
            after: params.after,
...
export async function getFulfillment(fulfillmentId) {
    ...
    const response = await client.list('/fulfillments', {
        version: '2.0',
        params: {},
    });
    // Find the fulfillment by ID from the list
    const fulfillmentsData = response.data || [];
    const fulfillment = fulfillmentsData.find((f) => f.id === fulfillmentId);
    if (!fulfillment) {
...
export async function createFulfillment(data) {
    const client = getClient();
    return client.post('/fulfillments', data, { version: '2.0' });
}
export async function updateFulfillment(fulfillmentId, data) {
    const client = getClient();
    return client.put(`/fulfillments/${fulfillmentId}`, data, { version: '2.0' });
}
export async function deleteFulfillment(fulfillmentId) {
    const client = getClient();
...
export async function getFulfillmentSummary() {
    const client = getClient();
    return client.getOne('/fulfillments/summary', { version: '2.0' });
}
export async function fulfillSaleLineItems(saleId, data) {
    const client = getClient();
    return client.post(`/sales/${saleId}/fulfillments/line_items`, data, { version: '2.0' });
}
export async function packSaleLineItems(saleId, data) {
    const client = getClient();
    return client.post(`/sales/${saleId}/fulfillments/pack`, data, { version: '2.0' });
}
export async function pickSaleLineItems(saleId, data) {
    const client = getClient();
    return client.post(`/sales/${saleId}/fulfillments/pick`, data, { version: '2.0' });
}
// Sale Fulfillments (on sale resource)
export async function fulfillSale(saleId, data) {
    const client = getClient();
    return client.post(`/sales/${saleId}/fulfillments`, data, { version: '2.0' });
}
export async function listSaleFulfillments(saleId, params) {
    const client = getClient();
    return client.list(`/sales/${saleId}/fulfillments`, {
        version: '2.0',
        params: {
            page_size: params.page_size,
            after: params.after,
...
// Pick List Tools
export async function listSalePickLists(saleId, params) {
    const client = getClient();
    return client.list(`/sales/${saleId}/pick_lists`, {
        version: '2.0',
        params: {
            page_size: params.page_size,
            after: params.after,
